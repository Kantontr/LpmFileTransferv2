...
class database:
    ...
    def EditUser(self,old_username,new_username,new_ip,new_port,new_comment):
        ...
        backup = [old_username, self.saved_user[old_username][0], self.saved_user[old_username][1], self.saved_user[old_username][2]] #creates backup in case new data is incorrect
